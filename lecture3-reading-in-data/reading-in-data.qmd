...
::: {.white-12-pt}
Dean Marengi \| Tuesday, January 13<sup>th</sup>, 2026
:::
...
- [**Always look at your data, and inspect it for potential data import problems**]{.blue-bold}

## Example: `read_delim()` {.smaller}
```{r, echo=T}
# Read in data and specify data types for specific columns and the delimiter used in the file
data <- read_delim("data/cvdstudy.txt", delim = "\t", na = c("N/A", "NA"),
                   col_types = cols(
                     id = col_character(),
                     smoke = col_factor(levels = c("0", "1")),
                     edu = col_factor(levels = c("1", "2", "3", "4"))
...
![](images/bus-data-before-after.png){.absolute right="0" bottom="70" height="50%"}
