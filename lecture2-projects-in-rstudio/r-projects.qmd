---
title: "<span style='color: white'>R Projects</span>"
format:
  revealjs:
    theme: [default, r-projects.scss]
slide-number: true
title-slide-attributes:
  data-background-image: "https://github.com/ID529/lectures/blob/main/graphics/transition_slides/alex-mesmer.jpg?raw=true"
...
## morals {data-background-image='https://github.com/ID529/lectures/blob/main/graphics/transition_slides/daniela-de-gol.jpg?raw=true' data-background-opacity='30%' data-background-color="black"}
...
## in brief... {data-background-image='https://github.com/ID529/lectures/blob/main/graphics/transition_slides/daniela-de-gol.jpg?raw=true' data-background-opacity='30%' data-background-color="black"}
...
<img src="images/goto_file_function.png" alt="window for go to file function">
...
:::{.columns}
:::{.column}
<img src="https://github.com/ID529/lectures/blob/main/graphics/HoduBubble.png?raw=true" alt="Hodu with a Bubble">
:::
:::{.column}
...
# key takeaways  {data-background-image='https://github.com/ID529/lectures/blob/main/graphics/transition_slides/lilzidesigns-2.jpg?raw=true' data-background-opacity='20%' data-background-color='black'}
...
## references {data-background-image='https://github.com/ID529/lectures/blob/main/graphics/transition_slides/prateek-pisat.jpg?raw=true' data-background-opacity='20%' data-background-color='black'}
